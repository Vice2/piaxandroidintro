...
class ShoppinglistFragment : Fragment() {
    ...
    var shoppadapter = ShoppingAdapter()
    var shopitems = mutableListOf<Shopitem>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        shoppadapter.shopfrag = this
        database = Firebase.database("https://piax-c448f-default-rtdb.europe-west1.firebasedatabase.app").reference
